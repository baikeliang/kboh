...
/***/ function(module, exports, __webpack_require__) {
	...
	var Login = _react2.default.createClass({
	  ...
	  handleSwipe: function handleSwipe(ev) {
	    var angle = 50;
	    var transform = {};
	    transform.ry = ev.direction & _reactHammerjs2.default.DIRECTION_HORIZONTAL ? 1 : 0;
	    transform.rx = ev.direction & _reactHammerjs2.default.DIRECTION_VERTICAL ? 1 : 0;
	    transform.angle = ev.direction & (_reactHammerjs2.default.DIRECTION_RIGHT | _reactHammerjs2.default.DIRECTION_UP) ? angle : -angle;
	    console.log(_reactHammerjs2.default.DIRECTION_RIGHT);
	    console.log(_reactHammerjs2.default.DIRECTION_LEFT);
	    console.log("!!!!!!!");
	    if (ev.direction & _reactHammerjs2.default.DIRECTION_RIGHT) {
	      console.log("right");
	      this.next();
	    } else {
	      console.log("left");
...
//# sourceMappingURL=0.b3972351790c18ee596e.hot-update.js.map