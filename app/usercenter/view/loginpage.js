        ...
        return (
            <div style={bodystyle}>
			    ...
			    <div className={loginstyles.nav}>
                   <a href="#" style={(bullet==0)?{color: "#9b9b9b",borderBottom: "4px solid #9b9b9b"}:{color: "#1b7c86",borderBottom: "4px solid #1b7c86"}}>验证码登录</a>
                   <a href="#" style={(bullet==1)?{color: "#9b9b9b",borderBottom: "4px solid #9b9b9b"}:{color: "#1b7c86",borderBottom: "4px solid #1b7c86"}}>密码登录</a>
					...
					<div>
                        <div className={loginstyles.wrapper}>
							...
							<div className={loginstyles['text-input-box']+' '+loginstyles.Mtop20}>
								<input type="text" className={loginstyles['input-text']} style={{fontSize:"16px"}} maxLength="6" id="code" placeholder="验证码"/>
