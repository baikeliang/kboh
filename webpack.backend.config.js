...
module.exports = {
    ...
    module: {
        ...
        {
          test: /\.css$/,
          exclude:/(common\.css|font-awesome\.min\.css|account\.css|table\.css|pagination\.css|z_user\.css|user\.css|H_user1\.css|index\.css|diyUpload\.css)/,
          loader: ExtractTextPlugin.extract('style-loader','css?modules&localIdentName=[name]__[local]')
        },
        {
          test: /(common\.css|font-awesome\.min\.css|account\.css|table\.css|pagination\.css|z_user\.css|user\.css|H_user1\.css|index\.css|diyUpload\.css)/, loader: ExtractTextPlugin.extract('style-loader', 'css?modules&localIdentName=[local]')
        },
