...
module.exports = {
    ...
    module: {
        ...
        {
          test: /\.css$/,
          exclude:/(common\.css|font-awesome\.min\.css|account\.css|table\.css|pagination\.css)/,
          loader: ExtractTextPlugin.extract('style-loader','css?modules&localIdentName=[name]__[local]')
        },
        {
          test: /(common\.css|font-awesome\.min\.css|account\.css|table\.css|pagination\.css)/, loader: ExtractTextPlugin.extract('style-loader', 'css?modules&localIdentName=[local]')
        },
